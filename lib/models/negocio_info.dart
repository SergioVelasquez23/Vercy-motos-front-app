class NegocioInfo {
  ...
  final String? dsResolutionNumber;   // Resolución DOCUMENTO SOPORTE (DS)
  ...
  factory NegocioInfo.fromJson(Map<String, dynamic> json) {
    return NegocioInfo(
      ...
      dsResolutionNumber: json['dsResolutionNumber'] ?? json['dsResolucion'],
      posResolutionNumber: json['posResolutionNumber'] ?? json['posResolucion'],
      posPrefijo: json['posPrefijo'] ?? json['prefijoPos'],
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      // Compatibilidad
      'telefono': telefono,
      'nit': nitDoc.isNotEmpty ? nitDoc : nit,
      'paginaWeb': paginaWeb,
      ...
      'dsResolutionNumber': dsResolutionNumber,
      'dsResolucion': dsResolutionNumber,
      'posResolutionNumber': posResolutionNumber,
      'posResolucion': posResolutionNumber,
      'posPrefijo': posPrefijo,
  ...
  NegocioInfo copyWith({
    ...
    return NegocioInfo(
      ...
      dsResolutionNumber: dsResolutionNumber ?? this.dsResolutionNumber,
