...
class _PedidoScreenState extends State<PedidoScreen> {
  ...
  Future<void> _continuarConCreacionPedido() async {
    ...
    // ✅ CAMBIO: El inventario ahora se descuenta al PAGAR el pedido, no al crearlo
    // Esto evita descontar inventario de pedidos que luego se cancelan
    // await _descontarCarnesDelInventario();
    print('ℹ️ El inventario se descontará cuando se pague este pedido');
